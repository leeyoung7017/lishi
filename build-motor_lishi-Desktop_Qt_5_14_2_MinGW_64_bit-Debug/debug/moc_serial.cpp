...
#include <memory>
#include "../../motor_lishi_v3_2/serial.h"
...
QT_MOC_LITERAL(4, 20, 13), // "on_ok_clicked"
QT_MOC_LITERAL(5, 34, 17) // "on_cancel_clicked"

    },
    "serial\0send\0\0closed\0on_ok_clicked\0"
    "on_cancel_clicked"
};
...
void serial::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serial::send)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (serial::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serial::closed)) {
                *result = 1;
                return;
            }
        }
